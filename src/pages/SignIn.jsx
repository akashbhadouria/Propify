            ...
            <div className='w-full lg:ml-20 md:w-[45%] lg:w-[40%]'>
              <form>
                ...
                <div className='flex justify-between mt-2 whitespace-nowrap text-sm sm:text-lg mb-6'>
                  ...
                  <button type='submit' className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-200 ease-in-out hover:shadow-lg active:bg-blue-800'>Sign in</button>
